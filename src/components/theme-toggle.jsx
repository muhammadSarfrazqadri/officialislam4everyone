...
export function ThemeToggle() {
  ...
  return (
    <motion.button
      ...
      className="relative w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#E14D4D] hover:text-white transition-all overflow-hidden"
    >
