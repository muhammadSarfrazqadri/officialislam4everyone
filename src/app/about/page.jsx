    ...
    <div className="min-h-screen bg-background font-sans">
      ...
      <section className="bg-[var(--secondary)] border-b-8 border-[var(--primary)] py-32 w-full relative overflow-hidden group">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <div className="w-24 h-1.5 bg-[var(--primary)] mx-auto opacity-80 shadow-[0_0_30px_rgba(225,77,77,0.8)]"></div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="flex flex-col gap-10">
            <div className="flex flex-col gap-4">
              <h2 className="text-4xl md:text-5xl font-black text-[var(--secondary)] uppercase tracking-tighter leading-none border-l-[12px] border-[var(--primary)] pl-8 mb-6">Our Vision</h2>
              <p className="text-xl text-slate-600 font-medium leading-relaxed">
                <span className="text-[var(--secondary)] font-black italic">ISLAM<span className="text-[var(--primary)]">4</span>EVERYONE</span> was born out of a desire to provide a digital sanctuary for authentic Islamic wisdom in an increasingly complex world.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 mt-6">
              <div className="bg-slate-50 p-8 rounded-3xl border border-border hover:border-[var(--primary)] transition-all group">
                <h4 className="text-3xl font-black text-[var(--secondary)] mb-2 group-hover:text-[var(--primary)]">100%</h4>
                <p className="text-xs font-black uppercase tracking-widest text-slate-400">Authentic Content</p>
              </div>
              <div className="bg-slate-50 p-8 rounded-3xl border border-border hover:border-[var(--primary)] transition-all group">
                <h4 className="text-3xl font-black text-[var(--secondary)] mb-2 group-hover:text-[var(--primary)]">Verified</h4>
          ...
          <div className="relative">
            <div className="aspect-square bg-slate-100 rounded-[4rem] overflow-hidden rotate-3 hover:rotate-0 transition-transform duration-700 border-8 border-white shadow-2xl relative z-10 flex items-center justify-center p-20">
               <div className="text-[12rem] text-[var(--primary)]/10 font-black italic select-none">I4E</div>
            </div>
            <div className="absolute -inset-4 bg-[var(--primary)]/5 rounded-[4rem] blur-2xl -z-0"></div>
          </div>
        </div>
      </section>

      {/* Values Section */}
      <section className="bg-slate-50 py-32 border-y border-border">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="flex flex-col items-center mb-24 text-center">
            <h3 className="text-4xl md:text-5xl font-black text-[var(--secondary)] uppercase tracking-tighter mb-4 underline decoration-[var(--primary)] decoration-8 underline-offset-8">Our Core Values</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="bg-background p-12 rounded-[3rem] shadow-xl hover:-translate-y-4 transition-all duration-500 border border-border group">
                <div className="text-6xl mb-8 group-hover:scale-125 transition-transform duration-500 inline-block">{value.icon}</div>
                <h4 className="text-3xl font-black text-[var(--secondary)] mb-4 uppercase tracking-tighter group-hover:text-[var(--primary)] transition-colors">{value.title}</h4>
