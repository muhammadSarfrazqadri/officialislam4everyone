...
const courses = [
   { id: 1, name: "Hifz & Nazra Quran", description: "Memorize the Quran with expert guidance and personalized support." },
   { id: 2, name: "Faizan-e-Shariat", description: "Learn the principles of Islamic jurisprudence with expert instructors." },
   { id: 3, name: "Arabic Language", description: "Master the Arabic language for better understanding of Islamic texts." },
   { id: 4, name: "Faizan-e-Hadith", description: "Study the sayings and actions of the Prophet Muhammad (PBUH)." },
   { id: 5, name: "Faizan-e-Tafseer", description: "Deepen your understanding of the Quran through detailed exegesis." },
   { id: 6, name: "Dars-e-Nizami", description: "Follow a structured curriculum for comprehensive Islamic education." },
   { id: 7, name: "Specialization in Fiqh", description: "Focus on the study of Islamic jurisprudence." },
   { id: 8, name: "Islamic Economics", description: "Learn about the economic principles in Islam." },
   { id: 9, name: "Hadith Specialization", description: "Dive deep into the study of Hadith literature." },
   { id: 10, name: "Fard Uloom", description: "Master the fundamental Islamic sciences." }
];
   ...
   return (
      <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
            ...
            <div className="container mx-auto px-6 relative z-10">
               ...
               >
                  <h1 className="text-5xl md:text-6xl font-black uppercase tracking-tighter mb-4 bg-gradient-to-r from-emerald-400 via-green-300 to-emerald-400 bg-clip-text text-transparent">
                     Al-Furqan Online Quran & Fiqh Academy
                  </h1>
                  <p className="text-gray-300 text-lg font-medium leading-relaxed max-w-2xl mx-auto">
                     Faith • Knowledge • Purpose • Success
                  </p>
                  <p className="text-gray-300 text-lg font-medium leading-relaxed max-w-2xl mx-auto">
                     Master the Quran & Sunnah with certified scholars from the comfort of your home.
                  </p>
                  <AnimatedButton variant="gold" className="px-14 mt-5 mr-4 h-12 text-lg shadow-xl">Apply Now</AnimatedButton>
                  <AnimatedButton variant="gold" className="px-14 mt-5 h-12 text-lg shadow-xl">Contact Us</AnimatedButton>
               </motion.div>
            </div>
         </section>
         ...
         <section className="relative z-20 -mt-10 px-4">
            <div className="max-w-6xl mx-auto bg-white/80 backdrop-blur-xl border border-black shadow-2xl rounded-[3rem] py-8 px-4 grid grid-cols-2 md:grid-cols-4 gap-4 overflow-hidden">
               {["5k+ Students", "100+ Universities", "10k+ Students", "15+ Countries"].map((s, i) => (
         ...
         <section className="py-32 max-w-7xl mx-auto px-4">
            <div className="text-center mb-20">
               <h2 className="text-4xl md:text-6xl font-serif text-primary mb-4">Why Choose Us?</h2>
               <div className="w-24 h-1 bg-accent mx-auto rounded-full" />
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
               {[
                  { icon: ShieldCheck, title: "Authentic Scholar", description: "Graduates from Verified Universities ." },
                  { icon: Users, title: "1-on-1 Classes", description: "Personalized attention for every single student." },
                  { icon: Globe2, title: "Global Standards", description: "Joining students from over 15 countries worldwide." }
               ].map((f, i) => (
                  <motion.div key={i} whileHover={{ y: -10 }} className="p-12 bg-white rounded-[3rem] border border-emerald-50 shadow-[0_20px_50px_rgba(0,0,0,0.03)] relative group overflow-hidden">
                     ...
                     <f.icon className="text-accent mb-8" size={56} />
         ...
         <section className="bg-[#04211D] py-32 border-y border-white/5 px-4 relative">
            <div className="max-w-7xl mx-auto">
               <h2 className="text-4xl md:text-6xl text-center mb-20 text-white font-serif">Specialized Programs</h2>
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {courses.map((i) => (
                  <div key={i.id} className="bg-white/5 border border-white/10 p-8 rounded-[2.5rem] hover:bg-white/[0.08] transition-all group backdrop-blur-sm">
                     ...
                     <h3 className="text-2xl text-white font-bold h-10 line-clamp-2 leading-snug">{i.name}</h3>
                     <p className="text-white/50 leading-relaxed mb-10 relative z-10">{i.description}</p>
                     <AnimatedButton variant="gold" className="w-full h-12 rounded-2xl">Enroll Now</AnimatedButton>
                  </div>
                  ))}
               </div>
            </div>
